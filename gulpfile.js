...
gulp.task('clean', function () {
  return gulp.src(
    ['./build-sampleapp', './tmp', './test-output', './.tmpbuild', './npmdist'],
...
gulp.task('inline.template.and.styles.to.component', function() {
  ...
  return gulp.src(['./src/my-date-picker/my-date-picker.component.ts'])
    ...
    .pipe(replace('styleUrls: ["./my-date-picker.component.css"],', 'styles: [' + '`' + styles + '`' + '],'))
    .pipe(replace('templateUrl: "./my-date-picker.component.html",', 'template: `' + htmlTpl + '`' + ','))
